...
killstreakNumber(){
	...
	if(!onceKSN){
		...
		;386 en 1920*1080
		yPlus := Round( (((screenHeight * 220 ) / 768) + 0.5) + 1 + 6 , 0) 
...
guessNumber(){
	...
	if(!once){
		...
		;5 pixel missing
		yColor1 := Round( (((screenHeight * 220 ) / 768) + 0.5) + 1 + 6 , 0)
		yColor2 := Round( (((screenHeight * 220 ) / 768) + 0.5) + 1 + 6 , 0)
		yColor3 := Round( (((screenHeight * 220 ) / 768) + 0.5) + 1 + 6 , 0)
		yColor4 := Round( (((screenHeight * 220 ) / 768) + 0.5) + 1 + 6 , 0) +3
		yColor5 := Round( (((screenHeight * 220 ) / 768) + 0.5) + 1 + 6 , 0) +7
		yColor6 := Round( (((screenHeight * 220 ) / 768) + 0.5) + 1 + 6 , 0) +15
		yColor7 := Round( (((screenHeight * 220 ) / 768) + 0.5) + 1 + 6 , 0) +15
		yColor8 := Round( (((screenHeight * 220 ) / 768) + 0.5) + 1 + 6 , 0) +9
